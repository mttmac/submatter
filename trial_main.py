...
def create_pipeline():
    ...
    face_nn.setBlobPath(str(Path("models/openvino-zoo-trial/face-detection-retail-0004/face-detection-retail-0004_openvino_2021.2_4shave.blob").resolve().absolute()))
    ...
    land_nn.setBlobPath(
        str(Path("models/openvino-zoo-trial/landmarks-regression-retail-0009/landmarks-regression-retail-0009_openvino_2021.2_4shave.blob").resolve().absolute())
    )
    ...
    gaze_nn.setBlobPath(
        str(Path("models/openvino-zoo-trial/gaze-estimation-adas-0002/gaze-estimation-adas-0002_openvino_2021.2_4shave.blob").resolve().absolute())
    )
    ...
    def face_thread(self):
        ...
        while self.running:
            ...
            for raw_bbox in self.bboxes:
                ...
                pose_data.setLayer("data", to_planar(det_frame, (224, 224)))
